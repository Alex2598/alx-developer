<section>
  <div class="parallax-container">
    <div class="container">
      <div class="hide-on-large-only" id="logo-header-container">
        <div id="logo-image">
        </div>
        <span class="text-logo-nav white-text" id="logo-text">
          A L X
          <span class="text-logo-nav" id="text_two">
            D e v e l o p e r
          </span>
        </span>
      </div>
    ...
    <div class="parallax grey darken-4" style="">
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col s12 m6" style="text-align: justify;">
        ...
        <div class="row center">
          ...
          <div class="col s4 m4">
            <p>
              <img alt="Responsabilidad" src="imagenes/respon.jpg" style="width: 40%;"/>
            </p>
            <p class="valores">
              Responsabilidad
            </p>
          ...
          <div class="col s4 m4">
            <p>
              <img alt="Compromiso" src="imagenes/comp.jpg" style="width: 40%;"/>
            </p>
            <p class="valores">
              Compromiso
            </p>
